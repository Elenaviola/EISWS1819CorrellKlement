...
public class MainMapActivity extends AppCompatActivity implements OnMapReadyCallback {
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(com.example.elvic.placetobe.MainMapActivity.this, "Standort konnte nicht gefunden werden", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    private void moveCamera(LatLng latLng, float zoom, String title) {
        ...
        private void initMap(){
            ...
            mapFragment.getMapAsync(com.example.elvic.placetobe.MainMapActivity.this);
